...
> **Konteks proyek:** Tugas Besar CLO2 — Konstruksi Perangkat Lunak, dikerjakan oleh kelompok 5 orang dengan spesifikasi: setiap anggota wajib menerapkan 2 teknik konstruksi (maks. 2 orang per teknik), Defensive Programming/Design by Contract, Unit Testing, Performance Testing, dan version control (branch pribadi + merge ke main).
...
## 🛡️ Design by Contract (DbC) — Ringkasan
...
- ✅ Spesifikasi kelas lengkap (Models, Interfaces, Automata, Utils, Repositories, Services, Controllers)
- ✅ Pembagian tugas per anggota dengan teknik konstruksi, DbC, unit test, dan performance test terdefinisi
- 🔄 Fase 1 (fondasi): dalam pengerjaan — Rayazka & Rafly
- ⏳ Fase 2 (implementasi): menunggu fondasi selesai
- ⏳ Fase 3 (testing): Minggu 3
